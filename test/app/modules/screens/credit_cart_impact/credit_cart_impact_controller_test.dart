...
void main() {
  ...
  // CreditCartImpactController creditcartimpact;
  //
  setUp(() {
    //     creditcartimpact = CreditCartImpactModule.to.get<CreditCartImpactController>();
  });

  group('CreditCartImpactController Test', () {
    //   test("First Test", () {
    //     expect(creditcartimpact, isInstanceOf<CreditCartImpactController>());
    //   });
